                ...
                <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="judul_project" value="{{ old('judul_project') }}"
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi_project" rows="5"
                                class="w-full bg-white/10 border border-white/20 text-white px-4 py-3 rounded-lg focus:outline-none focus:border-yellow-400"
                                required>{{ old('deskripsi_project') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="number" name="project_price" value="{{ old('project_price') }}" min="0"
                                class="w-full bg-white/10 border border-white/20 text-white px-4 py-3 rounded-lg focus:outline-none focus:border-yellow-400"
                                required>
                            @error('project_price')
                                <p class="text-red-400 text-xs mt-1">{{ $message }}</p>
